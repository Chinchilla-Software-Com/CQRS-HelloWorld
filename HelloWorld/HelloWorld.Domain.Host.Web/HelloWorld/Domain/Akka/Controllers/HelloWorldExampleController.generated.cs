...
// 	AggregateWebApiControllerTemplate.t4
// </auto-generated>
//------------------------------------------------------------------------------
...
namespace HelloWorld.Domain.Akka.Controllers
{
	...
	{
		protected Cqrs.Akka.Commands.IAkkaCommandSenderProxy<Cqrs.Authentication.SingleSignOnToken> CommandPublisher { get; private set; }
		...
		protected virtual IServiceResponse SayHelloWorld(IServiceRequestWithData<Cqrs.Authentication.SingleSignOnToken, HelloWorldExampleSayHelloWorldParameters> serviceRequest)
		{
			...
			var command = new SayHelloWorldCommand(rsn: Guid.NewGuid(), firstName: item.FirstName);
