...
namespace HelloWorld.Domain.Akka.Commands
{
	...
	public  partial class EndConversationCommand : ICommand<Cqrs.Authentication.SingleSignOnToken>
	{
		...
		/// <summary>
		/// Instantiate a new instance of the <see cref="EndConversationCommand"/> class
		/// </summary>
		public EndConversationCommand(Guid rsn, string firstName)
		{
			Rsn = rsn;
			FirstName = firstName;
		}
