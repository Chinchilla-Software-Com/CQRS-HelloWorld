...
namespace HelloWorld.Domain.Akka.Commands
{
	...
	public  partial class SayHelloWorldCommand : ICommand<Cqrs.Authentication.SingleSignOnToken>
	{
		...
		/// <summary>
		/// Instantiate a new instance of the <see cref="SayHelloWorldCommand"/> class
		/// </summary>
		public SayHelloWorldCommand(Guid rsn, string firstName)
		{
			Rsn = rsn;
			FirstName = firstName;
		}
