...
namespace HelloWorld.Domain.Akka.Events
{
	[GeneratedCode("CQRS UML Code Generator", "1.601.932")]
	[PublicEvent]
	[NotifyCallerEvent]
	public  partial class HelloWorldRepliedTo : IEvent<Cqrs.Authentication.SingleSignOnToken>
	{
		...
		/// <summary>
		/// Instantiate a new instance of the <see cref="HelloWorldRepliedTo"/> class
		/// </summary>
		public HelloWorldRepliedTo(Guid rsn, string firstName, string message)
		{
			Rsn = rsn;
			FirstName = firstName;
			Message = message;
