...
namespace HelloWorld.Domain.Akka.Events
{
	...
	[PublicEvent]
	[NotifyCallerEvent]
	public  partial class HelloWorldSaid : IEvent<Cqrs.Authentication.SingleSignOnToken>
	{
		...
		/// <summary>
		/// Instantiate a new instance of the <see cref="HelloWorldSaid"/> class
		/// </summary>
		public HelloWorldSaid(Guid rsn, string firstName, string message)
		{
			Rsn = rsn;
			FirstName = firstName;
			Message = message;
